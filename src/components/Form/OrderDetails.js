...
function OrderDetails() {
    return (
        <div className="narrow my-5" id="order-details">
                        ...
                        <button className="btn btn-lg btn-block btn-primary rounded my-5" type="submit" style="display: none;">
                            <span className="title">Add to Cart</span>
                        </button>

                        <a className="btn btn-lg btn-block btn-primary rounded my-5" href="shopping-cart.html">
                            <span className="title">Add to Cart</span>
                        </a>
